...
public class ChannelRecordActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        mItemList =new ArrayList<>();
        mItemList.add(new BaseGroup.Item("内侧堤坡问题：","请输入"));
        mItemList.add(new BaseGroup.Item(" — 处理意见：","请输入"));
        mItemList.add(new BaseGroup.Item("外侧堤坡问题：","请输入"));
        mItemList.add(new BaseGroup.Item(" — 处理意见：","请输入"));
        mItemList.add(new BaseGroup.Item("堤顶问题：","请输入"));
        mItemList.add(new BaseGroup.Item(" — 处理意见：","请输入"));
        mItemList.add(new BaseGroup.Item("堤脚问题：","请输入"));
        mItemList.add(new BaseGroup.Item(" — 处理意见：","请输入"));
        mGroupList.add(new BaseGroup("渠堤",mItemList));

        mItemList =new ArrayList<>();
        mItemList.add(new BaseGroup.Item("分水渠涵问题：","请输入"));
        mItemList.add(new BaseGroup.Item(" — 处理意见：","请输入"));
        mItemList.add(new BaseGroup.Item("倒虹问题：","请输入"));
        mItemList.add(new BaseGroup.Item(" — 处理意见：","请输入"));
        mGroupList.add(new BaseGroup("分水系统",mItemList));

        mItemList =new ArrayList<>();
        mItemList.add(new BaseGroup.Item("水簸箕问题：","请输入"));
        mItemList.add(new BaseGroup.Item(" — 处理意见：","请输入"));
        mItemList.add(new BaseGroup.Item("排水涵问题：","请输入"));
        mItemList.add(new BaseGroup.Item(" — 处理意见：","请输入"));
        mItemList.add(new BaseGroup.Item("排水沟问题：","请输入"));
        mItemList.add(new BaseGroup.Item(" — 处理意见：","请输入"));
